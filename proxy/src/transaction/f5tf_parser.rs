...
pub const F5TF_PROGRAM_ID: &str = "F5tfvbLog9VdGUPqBDTT8rgXvTTcq7e5UiGnupL1zvBq";

const BUY_TOKENS_IX: u8 = 0;
...
fn parse_buy_tokens_args(
    ...
    let user_index = instruction.accounts[6] as usize;
